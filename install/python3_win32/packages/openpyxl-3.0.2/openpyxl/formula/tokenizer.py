...
class Tokenizer(object):
    ...
    def _parse(self):
        """Populate database.items with the tokens from the formula."""
        if self.offset:
    ...
    def _parse_error(self):
        ...
        Looks for a match in database.ERROR_CODES and returns the number of
        characters matched. (Does not update database.offset)
    ...
    def _parse_whitespace(self):
        ...
        Returns the number of spaces found. (Does not update database.offset).
    ...
    def check_scientific_notation(self):
        ...
        Returns True if the character was consumed and database.offset was
