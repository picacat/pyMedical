...
class DialogDistinguish(QtWidgets.QDialog):
    ...
    # 設定GUI
    def _set_ui(self):
        self.ui = ui_settings.load_ui_file(ui_settings.UI_DIALOG_DISTINGUISH, self)
    ...
    def _set_distinguish_data(self, rec_no, rec):
        ...
        for column in range(0, self.ui.tableWidget_distinguish.columnCount()):
            self.ui.tableWidget_distinguish.setItem(rec_no, column, QtWidgets.QTableWidgetItem(distinguish_rec[column]))
    ...
    def add_distinguish(self):
        ...
        self.text_edit.setText(strings.get_str(distinguish, 'utf8'))
