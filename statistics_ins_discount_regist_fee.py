...
class StatisticsInsDiscountRegistFee(QtWidgets.QMainWindow):
    ...
    def _read_data(self):
        ...
        sql = '''
            SELECT  
                CaseKey, CaseDate, Period, TreatType, Doctor, Continuance, RegistFee,
                patient.*
            FROM cases
    ...
    def _set_table_data(self, row_no, row):
        ...
        medical_record = [
            ...
            self.basic_regist_fee,
            regist_fee,
            self.basic_regist_fee - regist_fee,
