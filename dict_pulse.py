...
class DictPulse(QtWidgets.QMainWindow):
    ...
    # 設定GUI
    def _set_ui(self):
        self.ui = ui_settings.load_ui_file(ui_settings.UI_DICT_PULSE, self)
    ...
    def _set_dict_pulse_data(self, rec_no, rec):
        ...
        for column in range(0, self.ui.tableWidget_dict_pulse.columnCount()):
            self.ui.tableWidget_dict_pulse.setItem(rec_no, column, QtWidgets.QTableWidgetItem(dict_pulse_rec[column]))
