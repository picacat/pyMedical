...
class PrintCertificateDiagnosis:
    ...
    def _get_html(self):
            ...
            <html>
              <body>
                ...
                <table align=center cellpadding="10" cellspacing="0" width="98%" style="font-size: 14px; border-width: 1px; border-style: solid;">
                  <tbody>
                    <tr>
                        <th style="text-align: left; vertical-align: middle">診斷 <font size="3">Diagnosis</font></th>
                    </tr>
                    <tr>
                        <td>{diagnosis}<br><br><br><br></td>
                    </tr>
                    <tr>
                        <th style="text-align: left; vertical-align: middle">醫囑 <font size="3">Doctor's Comment</font></th>
                    </tr>
                    <tr>
        ...
        '''.format(
            ...
            nationality=string_utils.xstr(patient_row['Nationality']),
