...
from dialog import dialog_massage_purchase_list
from classes import table_widget
from printer import print_receipt


# 櫃台購藥
class MassagePurchaseList(QtWidgets.QMainWindow):
    program_name = '養生館購物'

    # 初始化
    def __init__(self, parent=None, *args):
        super(MassagePurchaseList, self).__init__(parent)
        self.parent = parent
    ...
    # 設定GUI
    def _set_ui(self):
        self.ui = ui_utils.load_ui_file(ui_utils.UI_MASSAGE_PURCHASE_LIST, self)
    ...
    def _set_signal(self):
        ...
        self.ui.action_open_record.triggered.connect(self.open_massage_record)
        ...
        self.ui.tableWidget_purchase_list.doubleClicked.connect(self.open_massage_record)
    ...
    def _set_table_data(self, row_no, row):
        content = self._get_purchase_content(row['MassageCaseKey'])
    ...
    def _get_purchase_content(self, massage_case_key):
        sql = '''
            SELECT * FROM massage_prescript
            WHERE
                MassageCaseKey = {0}
            ORDER BY MassagePrescriptKey
        '''.format(massage_case_key)
    ...
    def delete_purchase(self):
        ...
        massage_case_key = self.table_widget_purchase_list.field_value(0)
    ...
    def open_massage_record(self):
        massage_case_key = self.table_widget_purchase_list.field_value(0)
        self.parent.open_massage_purchase_tab('養生館購物', massage_case_key)
    ...
    def refresh_purchase(self):
        ...
        sql = 'SELECT * FROM massage_cases where MassageCaseKey = {0}'.format(case_key)
    ...
    # 輸入購物資料
    def _purchase(self):
        self.parent.open_massage_purchase_tab('養生館購物')
